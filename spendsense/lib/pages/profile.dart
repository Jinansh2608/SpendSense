...
class ProfilePage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  CircleAvatar(radius: width * 0.1, backgroundColor: Colors.grey[300]),
                  SizedBox(width: width * 0.04),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Yash Parmar', style: TextStyle(fontSize: width * 0.05, fontWeight: FontWeight.bold)),
                      SizedBox(height: height * 0.004),
                      Text('yash@email.com', style: TextStyle(fontSize: width * 0.035, color:const Color.fromARGB(255, 152, 152, 152))),
                      SizedBox(height: height * 0.004),
            ...
            Center(
              child: Wrap(
                ...
                children: [
                  ...
                  _walletTile(context,'Add Wallet', 1, Icons.add, isAdd: true),
                ],
              ),
            ),
            ...
            Align(
              ...
              child: TextButton(onPressed: () {}, child: Text('Show all budgets',style: TextStyle(color: Ycolor.primarycolor),)),
            ),
  ...
  return Container(
    height: height*0.14,
    width: width * 0.44, // responsive width
    ...
    child: Column(
      ...
      children: [
        ...
        isAdd? 
            ...
            Container(
            height: height*0.03,
            child: Text("₹${amt.toStringAsFixed(2)}", style: TextStyle(fontSize: 13, color: Colors.grey[700])))
